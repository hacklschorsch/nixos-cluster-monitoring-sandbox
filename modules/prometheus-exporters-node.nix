...

{
  ...
  config.services.prometheus.exporters.node.enable = true;

  config.services.prometheus.exporters.node.enabledCollectors = [
    "logind"
    "systemd"
  ];
  config.services.prometheus.exporters.node.disabledCollectors = [
    "textfile"
  ];
